...
public class LastYearFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_last_year, container, false);
    ...
    private void init(View v){
        ...
        recyclerView = v.findViewById(R.id.lastyear_recycler);
    ...
    private List<History> getData(){
        ...
        for(int i=0;i<activitiesList.size();i++) {
            ...
            String total = myRoomDatabase.myDao().getPreviousYearData(today, activitiesList.get(i).getName());
