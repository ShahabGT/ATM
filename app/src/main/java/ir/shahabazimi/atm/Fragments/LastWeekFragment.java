...
public class LastWeekFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_last_week, container, false);
    ...
    private void init(View v){
        ...
        recyclerView = v.findViewById(R.id.lastweek_recycler);
    ...
    private List<History> getData(){
        ...
        for(int i=0;i<activitiesList.size();i++) {
            ...
            String total = myRoomDatabase.myDao().getPreviousWeekData(today, activitiesList.get(i).getName());
